...
{
    internal class DefenderAPI
    {
        public DefenderAPI(){}
        public void addExclusionFolder(string path) 
        {
        ...
        public void addExclusionExtension(string ext) 
        {
            using (PowerShell PowerShellInst = PowerShell.Create())
            {
                PowerShellInst.AddScript(@"Add-MpPreference -ExclusionExtension '" + ext + "'");
                Collection<PSObject> PSOutput = PowerShellInst.Invoke();
                Console.WriteLine(ext + " to Windows Defender [added][+]");
                Console.Read();
            }
        }
        public void addExclusionProcess(string process) 
        {
            using (PowerShell PowerShellInst = PowerShell.Create())
            {
                PowerShellInst.AddScript(@"Add-MpPreference -ExclusionProcess '" + process + "'");
                Collection<PSObject> PSOutput = PowerShellInst.Invoke();
                Console.WriteLine(process + " to Windows Defender [added][+]");
                Console.Read();
            }
        }
        public void addExclusionIpAddress(string ipaddress) 
        {
            using (PowerShell PowerShellInst = PowerShell.Create())
            {
                PowerShellInst.AddScript(@"Add-MpPreference -ExclusionIpAddress '" + ipaddress + "'");
                Collection<PSObject> PSOutput = PowerShellInst.Invoke();
                Console.WriteLine(ipaddress + " to Windows Defender [added][+]");
                Console.Read();
            }
        }
